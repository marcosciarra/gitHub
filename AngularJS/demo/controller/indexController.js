...
app.controller("demoController", ['$scope', function ($scope) { /*definisco il controller e la variabile di $scope*/
    ...
    $scope.firstname = "Marco";
    $scope.lastname = "";

    //ESEMPIO 3: definisco una function che richiamo all' ng-click dalla pagina di front
    $scope.mostraNomeCognome = function () {
        alert('Ciao ' + $scope.firstname + ' ' + $scope.lastname);
        console.log('Nome: ' + $scope.firstname);
        console.log(' Cognome: ' + $scope.lastname);
    };
