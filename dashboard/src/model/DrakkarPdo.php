...
require_once 'DrakkarDbConnectorInterface.php';
require_once 'DrakkarException.php';
require_once 'DrakkarConnectionException.php';
require_once 'DrakkarDbStructureException.php';
require_once 'DrakkarIntegrityConstrainException.php';
require_once 'DrakkarDuplicatePrimaryException.php';

class DrakkarPdo implements DrakkarDbConnectorInterface
{
    //private $logger;
    ...
    public function __construct($conn = null)
    {
        ...
        //            }
        //        }
        //        elseif ($conn instanceof DrakkarPdo) {
