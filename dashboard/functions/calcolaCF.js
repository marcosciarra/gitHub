...
CFisc.trova_comune=function(pattern_comune)
{
    ...
    for(codice in this.codici_catastali)
    {
        ...
        if(codice == pattern_comune) {ret.push([comune,codice]);return ret}
    }
    return ret
}
...
CFisc.calcola_codice=function(nome,cognome,sesso,giorno,mese,anno,luogo,codiceCatastale)
{
    var codice=
        this.calcola_codice_cognome(cognome)+
        this.calcola_codice_nome(nome)+
        this.calcola_codice_data(giorno,mese,anno,sesso)+
        this.calcola_codice_comune(codiceCatastale)
