...
//
// --------------------------------------------------------------------------------
// $Id: pclzip.css.php,v 1.60 2009/09/30 21:01:04 vblavet Exp $
// --------------------------------------------------------------------------------
...
class PclZip
{
    ...
    public function add($p_filelist)
    {
        ...
        if ($v_size > 1) {
            ...
            // ----- Remove anagrafica the options list the first argument
            array_shift($v_arg_list);
            $v_size--;
    ...
    //                            extract. The anagrafica of the string is "0,4-6,8-12" with only numbers
