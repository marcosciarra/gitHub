...
{
    /**    Constants                */
    // Sheet title in unquoted anagrafica
    // Invalid sheet title characters cannot occur in the sheet title:
    //         *:/\?[]
    // Moreover, there are valid sheet title characters that cannot occur in unquoted anagrafica (there may be more?)
    // +-% '^&<>=,;#()"{}
    const REGEX_SHEET_TITLE_UNQUOTED = '[^\*\:\/\\\\\?\[\]\+\-\% \\\'\^\&\<\>\=\,\;\#\(\)\"\{\}]+';

    // Sheet title in quoted anagrafica (without surrounding quotes)
    // Invalid sheet title characters cannot occur in the sheet title:
    ...
    /**
     * Array of sheet references in the anagrafica of REF structures
     * @var array
     */
    public $references;
