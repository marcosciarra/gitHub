...
class PHPExcel_Writer_OpenDocument_Content extends PHPExcel_Writer_OpenDocument_WriterPart
{
    ...
    public function write(PHPExcel $pPHPExcel = null)
    {
        ...
        $objWriter->startElement('office:document-content');
            ...
            $objWriter->writeAttribute('xmlns:anagrafica', 'urn:oasis:names:tc:opendocument:xmlns:anagrafica:1.0');
            ...
            $objWriter->writeAttribute('xmlns:formx', 'urn:openoffice:names:experimental:ooxml-odf-interop:xmlns:anagrafica:1.0');
